...
<body class="bg-gray-100 min-h-screen">
    ...
    <main class="p-6 max-w-7xl mx-auto flex space-x-6">
        ...
        <section class="w-2/5 bg-white rounded shadow p-4 flex flex-col max-h-[80vh]">
            ...
            <div class="flex space-x-4">
                ...
                <button type="button" id="clearBillBtn" class="flex-1 bg-red-600 text-white py-2 rounded hover:bg-red-700 transition">Clear</button>
            </div>
            </form>
        </section>
    </main>
    ...
    <script>
        ...
        // Use event delegation to handle product card clicks
