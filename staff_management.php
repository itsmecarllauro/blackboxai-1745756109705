    ...
    <main class="p-6 max-w-4xl mx-auto">
        ...
        <section class="mb-8 flex justify-center">
            <div class="w-full max-w-md">
                ...
                <form method="POST" class="space-y-4 bg-[#FDF6EC] p-6 rounded shadow">
                    ...
                    <button type="submit" class="bg-[#A97142] text-white py-2 px-4 rounded hover:bg-[#8B5E3C] transition">Add Staff</button>
            ...
            <thead class="bg-[#A97142] text-white">
                ...
                <tbody>
                    ...
                    <tr class="border-b border-gray-200">
                        ...
                        <button onclick="editStaff(<?php echo $member['id']; ?>, '<?php echo htmlspecialchars(addslashes($member['username'])); ?>', '<?php echo $member['role']; ?>')" class="bg-[#C8A17D] text-white px-3 py-1 rounded hover:bg-[#A57C4D] transition">Edit</button>
        ...
        <div class="bg-[#FDF6EC] p-6 rounded shadow max-w-md w-full">
                ...
                <form method="POST" id="editForm" class="space-y-4">
                    ...
                    <button type="button" onclick="closeEditModal()" class="px-4 py-2 rounded border border-[#C8A17D] bg-[#C8A17D] text-white hover:bg-[#A57C4D] transition">Cancel</button>
